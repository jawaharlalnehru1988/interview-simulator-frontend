...
export const APP_ROUTES: AppRoute[] = [
  ...
  },
  {
    ...
    cardEyebrow: "Career Analysis",
    cardTitle: "Resume Analyzer",
    cardDescription: "Upload your resume to extract text, generate custom interview questions, and practice with AI-generated answers.",
    showInDropdown: true,
    showAsCard: true,
  },
  {
  ...
  },
  {
    path: "/documents",
    name: "Documents",
    cardEyebrow: "Secure Vault",
    cardTitle: "My Documents",
    cardDescription: "Access all your uploaded documents — PDFs, images, certificates, and more — in one place with previews and direct downloads.",
    showInDropdown: true,
    showAsCard: true,
  },
  {
